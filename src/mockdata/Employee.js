import { UIUtils, TypedObject } from '../js/library'
/**
...
export default class Employee extends TypedObject {
    ...
    static createEmployee(fName, hDate, lName) {
        ...
        employee.employeeId = Employee.index++;
        employee.phoneNumber = `${Employee.areaCodes[Employee.getRandom(0, 3)]}-${Employee.getRandom(100, 999).toString()}-${Employee.getRandom(1000, 9999).toString()}`;
        employee.isActive = Employee.getRandom(1, 2) == 1;
    ...
    static createAddress(stateCode) {
        ...
        address.validFrom = new Date(Employee.getRandom(2007, 2012), Employee.getRandom(0, 11), Employee.getRandom(1, 28));
        address.validTo = new Date(Employee.getRandom(2012, 2017), Employee.getRandom(0, 11), Employee.getRandom(1, 28));
        return address;
    ...
    getDetails() {
        return `${this.employeeId}. ${this.firstName} ${this.lastName}, ${this.phoneNumber}, ${this.department}, ${this.stateCode}, ${UIUtils.formatCurrency(this.annualSalary)}, ${UIUtils.formatDate(this.hireDate)}`
    }
